...
[role="lead"]
Sie können ein Upgrade von Unified Manager 9.9 oder 9.10 auf 9.11 durchführen, indem Sie die Installationsdatei auf der Windows-Plattform herunterladen und ausführen.
