...
[role="lead"]
Sie können ein Upgrade von Unified Manager 9.9 oder 9.10 auf 9.11 durchführen, indem Sie die Installationsdatei auf der Linux-Plattform herunterladen und ausführen.
...
* MySQL Community Edition wird beim Unified Manager Upgrade automatisch aktualisiert. Wenn die installierte Version von MySQL auf Ihrem System älter als 8.0 ist, 28 aktualisiert der Unified Manager-Upgradeprozess MySQL automatisch auf 8.0.28.
